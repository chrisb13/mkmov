# -*- coding: utf-8 -*-
#
# MkMov documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'mkmov', u'MkMov Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'MkMov', u'MkMov Documentation',
   author, 'MkMov', 'One line description of project.',
   'Miscellaneous'),
]
